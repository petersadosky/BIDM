userYelp <- readLines("~/Downloads/yelp_dataset_challenge_academic_dataset/yelp_academic_dataset_user.json")

extract <- function(rowNumber) {
	row <- userYelp[rowNumber]
	rowClean <- gsub("\\{|\\}|\\\"", "", row)
...
write.csv(userCSV, "~/Documents/School/94832 - S15/NEW-yelp-user.csv")
